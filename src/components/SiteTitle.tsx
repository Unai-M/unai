...
export default function SiteTitle() {
  return (
    <motion.div className="text-background absolute flex h-screen w-full flex-col items-center justify-start font-black">
      <motion.h1
        initial={{ y: 400 }}
        animate={{ y: [400, 400, 0] }}
        transition={{ duration: 3, ease: "easeOut", times: [0, 0.75, 1] }}
        className="font-display text-blue _text-[6.5vw] _bg-white/80 flex w-full gap-4 text-[7vw] leading-none tracking-tight uppercase [font-variation-settings:'opsz'_80]"
      >
